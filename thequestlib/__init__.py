BLACK = (0, 0, 0)
WHITE = (255, 255, 255)
#IMPORTANT: PLANET_SPEED CANT BE GREATER THAN 25% OF THE SLOWER OBSTACLE. FOR EXAMPLE IF ASTEROID SPEED IS CHANGED TO 2, PLANET SPEED CANT BE GREATER THAN 0.5
STAR_SPEEDS = (1, 2, 3)
STARS_AMOUNT = 250
ASTEROIDS_SPEED = 4
ASTEROIDS_AMOUNT = 25
